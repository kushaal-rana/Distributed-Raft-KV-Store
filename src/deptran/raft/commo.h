...
namespace janus
{
  ...
  public:
    ...
    shared_ptr<IntEvent> SendRequestVote(parid_t par_id,
                                         siteid_t site_id,
    ...
    shared_ptr<IntEvent> SendAppendEntries(parid_t par_id,
                                           siteid_t site_id,
                                           uint64_t leaderId,
                                           uint64_t leaderTerm,
    ...
    shared_ptr<IntEvent> SendHeartBeat(parid_t par_id,
                                       siteid_t site_id,
                                       uint64_t candidateId,
                                       uint64_t candidateTerm,
                                       uint64_t *ret,
